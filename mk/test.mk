...
test-up:
	docker-compose -f docker-compose-test.yaml up -d postgres-test redis-test minio-test test-a2a-agent flows_worker_test scheduler_test rag_worker_test livekit-test livekit-egress-test livekit-cli-test
...
test-down:
	docker-compose -f docker-compose-test.yaml stop postgres-test redis-test minio-test test-a2a-agent flows_worker_test scheduler_test rag_worker_test livekit-test livekit-egress-test livekit-cli-test
