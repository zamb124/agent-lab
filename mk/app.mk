...
# Все локальные сервисы (все ключи SERVICES в scripts/run.py, в т.ч. flows, frontend, crm, rag, sync, office, browser,
...
APP_MAK_SVC := flows frontend crm rag sync office scheduler-api browser provider_litserve voice \
