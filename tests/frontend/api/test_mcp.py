...
class TestMCPServerListAPI:
    """Тесты для GET /frontend/api/v1/mcp/servers endpoint"""
    
    @pytest.mark.asyncio
    async def test_list_servers(self, frontend_client, test_mcp_server):
        """Проверяем получение списка MCP серверов"""
        response = await frontend_client.get("/frontend/api/v1/mcp/servers")
...
class TestMCPServerDetailAPI:
    """Тесты для GET /frontend/api/v1/mcp/servers/{server_id} endpoint"""
    
    @pytest.mark.asyncio
    async def test_get_server(self, frontend_client, test_mcp_server):
        """Проверяем получение MCP сервера по ID"""
        response = await frontend_client.get(f"/frontend/api/v1/mcp/servers/{test_mcp_server.server_id}")
    ...
    async def test_get_server_not_found(self, frontend_client):
        ...
        response = await frontend_client.get("/frontend/api/v1/mcp/servers/nonexistent_server")
        
        assert response.status_code == 404


class TestMCPServerCreateAPI:
    """Тесты для POST /frontend/api/v1/mcp/servers endpoint"""
    ...
    async def test_create_mcp_server(self, frontend_client, frontend_mcp_repo):
        ...
        response = await frontend_client.post("/frontend/api/v1/mcp/servers", json=server_data)
...
class TestMCPServerUpdateAPI:
    """Тесты для PUT /frontend/api/v1/mcp/servers/{server_id} endpoint"""
    ...
    async def test_update_mcp_server(self, frontend_client, test_mcp_server):
        ...
        response = await frontend_client.put(
            f"/frontend/api/v1/mcp/servers/{test_mcp_server.server_id}",
    ...
    async def test_update_mcp_server_not_found(self, frontend_client):
        ...
        response = await frontend_client.put(
            "/frontend/api/v1/mcp/servers/nonexistent_server",
...
class TestMCPServerDeleteAPI:
    """Тесты для DELETE /frontend/api/v1/mcp/servers/{server_id} endpoint"""

    @pytest.mark.asyncio
    async def test_delete_mcp_server(self, frontend_client, test_mcp_server, frontend_mcp_repo):
        """Проверяем удаление MCP сервера"""
        response = await frontend_client.delete(f"/frontend/api/v1/mcp/servers/{test_mcp_server.server_id}")
    ...
    async def test_delete_mcp_server_not_found(self, frontend_client):
        ...
        response = await frontend_client.delete("/frontend/api/v1/mcp/servers/nonexistent_server")
        assert response.status_code == 404
