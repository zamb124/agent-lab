...
class TestWebhookVerification:
    ...
    def test_webhook_verify_success(self, client, mock_flow_config):
        ...
        with patch('app.core.storage.Storage.get_flow_config', return_value=mock_flow_config):
    ...
    def test_webhook_verify_flow_not_found(self, client):
        ...
        with patch('app.core.storage.Storage.get_flow_config', return_value=None):
            response = client.get(
    ...
    def test_webhook_verify_no_whatsapp_platform(self, client):
        ...
        with patch('app.core.storage.Storage.get_flow_config', return_value=flow_without_wa):
            response = client.get(
...
class TestAdminRegisterFlow:
    ...
    def test_register_flow_no_whatsapp_platform(self, client):
        ...
        with patch('app.core.storage.Storage.get_flow_config', return_value=flow_no_wa):
...
class TestAdminPhoneInfo:
    ...
    def test_get_phone_info_success(self, client, mock_flow_config):
        ...
        mock_api_response = AsyncMock()
        mock_api_response.status_code = 200
        mock_api_response.json = AsyncMock(return_value=mock_phone_data)
