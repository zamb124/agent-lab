...
async def premium_test_tool(input_text: str) -> str:
...
class TestToolFactory:
    ...
    async def test_create_tool_with_billing(self, tool_factory):
        ...
        tool_ref = ToolReference(
            tool_id="tests.agents.billing.test_tool_billing.expensive_test_tool",
            code_mode=CodeMode.CODE_REFERENCE,
            function_path="tests.agents.billing.test_tool_billing.expensive_test_tool",
    ...
    async def test_free_tool_execution(self, tool_factory, test_context):
        ...
        tool_ref = ToolReference(
            tool_id="tests.agents.billing.test_tool_billing.free_test_tool",
            code_mode=CodeMode.CODE_REFERENCE,
            function_path="tests.agents.billing.test_tool_billing.free_test_tool",
    ...
    async def test_tool_premium_free_access(self, tool_factory, test_context, test_user, test_company):
        ...
        tool_ref = ToolReference(
            tool_id="tests.agents.billing.test_tool_billing.premium_test_tool",
            code_mode=CodeMode.CODE_REFERENCE,
            function_path="tests.agents.billing.test_tool_billing.premium_test_tool",
