...
class TestA2AAgentCard:
    ...
    @pytest.fixture
    async def agent_id(self, client):
        return "example_react"

    @pytest.mark.asyncio
    async def test_agent_card_exists(self, client, agent_id, auth_headers_system):
        """Agent Card доступен и имеет правильную структуру."""
        resp = await client.get(f"/agents/api/v1/{agent_id}", headers=auth_headers_system)
    ...
    async def test_agent_card_404(self, client):
        ...
        resp = await client.get("/agents/api/v1/nonexistent_flow_xyz")
        assert resp.status_code == 404

    @pytest.mark.asyncio
    async def test_agent_card_skills(self, client, agent_id):
        """Agent Card содержит skills в правильном формате."""
        resp = await client.get(f"/agents/api/v1/{agent_id}")
        card = resp.json()
...
class TestA2AMessageSend:
    ...
    @pytest.mark.asyncio
    async def test_message_send_returns_valid_task(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_message_send_with_context_id(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_message_send_history(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    async def test_unknown_flow_error(self, client):
        ...
        resp = await client.post(
            "/agents/api/v1/unknown_flow_xyz",
            json={
                "jsonrpc": "2.0",
                "id": "1",
                "method": "message/send",
...
class TestA2ATasksGet:
    ...
    @pytest.mark.asyncio
    async def test_tasks_get_returns_valid_task(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_tasks_get_with_history_length(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_tasks_get_not_found(self, client, agent_id):
...
class TestA2ATasksCancel:
    ...
    @pytest.mark.asyncio
    async def test_tasks_cancel_returns_canceled_task(self, client, agent_id, mock_llm_with_queue, sync_tools):
...
class TestA2AMessageStream:
    ...
    @pytest.mark.asyncio
    async def test_stream_returns_sse(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_stream_events_are_valid(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_stream_has_final_event(self, client, agent_id, mock_llm_with_queue, sync_tools):
...
class TestA2AInterrupt:
    ...
    @pytest.mark.asyncio
    async def test_interrupt_returns_input_required(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_resume_after_interrupt(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_tasks_get_shows_input_required(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_stream_interrupt_has_input_required_event(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    async def test_resume_preserves_task_id_and_receives_response(
        self, client, agent_id, mock_llm_with_queue, sync_tools
    ):
        """
...
class TestA2APushNotificationConfig:
    ...
    @pytest.mark.asyncio
    async def test_set_config_valid_response(self, client, agent_id):
    ...
    @pytest.mark.asyncio
    async def test_get_config_valid_response(self, client, agent_id):
    ...
    @pytest.mark.asyncio
    async def test_list_configs_valid_response(self, client, agent_id):
    ...
    @pytest.mark.asyncio
    async def test_delete_config_valid_response(self, client, agent_id):
...
class TestA2ASkills:
    ...
    @pytest.mark.asyncio
    async def test_list_skills_valid_response(self, client, agent_id):
        """GET /agents/{id}/skills возвращает список skills."""
        resp = await client.get(f"/agents/api/v1/{agent_id}/skills")
        assert resp.status_code == 200
    ...
    @pytest.mark.asyncio
    async def test_get_skill_valid_response(self, client, agent_id):
        """GET /agents/{id}/skills/{skill_id} возвращает skill."""
        # Сначала получаем список skills
        list_resp = await client.get(f"/agents/api/v1/{agent_id}/skills")
        ...
        resp = await client.get(f"/agents/api/v1/{agent_id}/skills/{skill_id}")
        assert resp.status_code == 200
    ...
    async def test_get_skill_tools_react_flow(self, client):
        """GET /agents/{id}/skills/{skill_id}/tools для react flow возвращает tools."""
        agent_id = "example_react"
        skill_id = "concise"

        resp = await client.get(f"/agents/api/v1/{agent_id}/skills/{skill_id}/tools")
        assert resp.status_code == 200
    ...
    async def test_get_skill_tools_graph_flow(self, client):
        """GET /agents/{id}/skills/{skill_id}/tools для графового flow возвращает tools, nodes и edges."""
    ...
    @pytest.mark.asyncio
    async def test_get_skill_tools_includes_all_react_node_nodes(self, client):
        """Проверяет, что tools собираются из всех react_node нод."""
        agent_id = "example_graph"
        skill_id = "fast_track"
    ...
    async def test_get_skill_tools_404_for_nonexistent_flow(self, client):
        """GET /agents/{id}/skills/{skill_id}/tools возвращает 404 для несуществующего flow."""
        resp = await client.get("/agents/api/v1/nonexistent_flow/skills/default/tools")
        assert resp.status_code == 404

    @pytest.mark.asyncio
    async def test_get_skill_tools_404_for_nonexistent_skill(self, client):
        """GET /agents/{id}/skills/{skill_id}/tools возвращает 404 для несуществующего skill."""
        agent_id = "example_react"
        resp = await client.get(f"/agents/api/v1/{agent_id}/skills/nonexistent_skill/tools")
        assert resp.status_code == 404

    @pytest.mark.asyncio
    async def test_get_skill_schema_valid_response(self, client):
        """GET /agents/{id}/schema возвращает JSON Schema в формате ISchema."""
        agent_id = "example_react"

        resp = await client.get(f"/agents/api/v1/{agent_id}/schema")
        assert resp.status_code == 200
    ...
    async def test_get_skill_schema_404_for_nonexistent_flow(self, client):
        """GET /agents/{id}/schema возвращает 404 для несуществующего flow."""
        resp = await client.get("/agents/api/v1/nonexistent_flow/schema")
        assert resp.status_code == 404

    @pytest.mark.asyncio
    async def test_create_skill_valid(self, client, agent_id, unique_id):
        """POST /agents/{id}/skills создаёт новый skill."""
        skill_id = f"test_skill_{unique_id}"
        
        resp = await client.post(
            f"/agents/api/v1/{agent_id}/skills",
            json={
                "skill_id": skill_id,
                "name": "Test Skill",
        ...
        # Проверяем что skill создан
        get_resp = await client.get(f"/agents/api/v1/{agent_id}/skills/{skill_id}")
        ...
        # Cleanup
        await client.delete(f"/agents/api/v1/{agent_id}/skills/{skill_id}")

    @pytest.mark.asyncio
    async def test_create_skill_duplicate(self, client, agent_id, unique_id):
        """POST /agents/{id}/skills возвращает 409 для существующего skill."""
        skill_id = f"test_skill_dup_{unique_id}"
    ...
    @pytest.mark.asyncio
    async def test_create_skill_missing_skill_id(self, client, agent_id):
        """POST /agents/{id}/skills возвращает 400 без skill_id."""
        resp = await client.post(
            f"/agents/api/v1/{agent_id}/skills",
            json={
                "name": "Test Skill",
    ...
    async def test_create_skill_404_for_nonexistent_flow(self, client, unique_id):
        """POST /agents/{id}/skills возвращает 404 для несуществующего flow."""
        resp = await client.post(
            "/agents/api/v1/nonexistent_flow/skills",
            json={
                "skill_id": f"test_skill_{unique_id}",
                "name": "Test Skill",
            },
    ...
    @pytest.mark.asyncio
    async def test_update_skill_valid(self, client, agent_id, unique_id):
        """PUT /agents/{id}/skills/{skill_id} обновляет существующий skill."""
        skill_id = f"test_skill_update_{unique_id}"
        ...
        update_resp = await client.put(
            f"/agents/api/v1/{agent_id}/skills/{skill_id}",
            json={
                "skill_id": skill_id,
                "name": "Updated Name",
    ...
    @pytest.mark.asyncio
    async def test_update_skill_404_for_nonexistent_skill(self, client, agent_id, unique_id):
        """PUT /agents/{id}/skills/{skill_id} возвращает 404 для несуществующего skill."""
        resp = await client.put(
            f"/agents/api/v1/{agent_id}/skills/nonexistent_skill_{unique_id}",
            json={
                "skill_id": f"nonexistent_skill_{unique_id}",
                "name": "Test Skill",
            },
        )
        assert resp.status_code == 404
    ...
    async def test_update_skill_404_for_nonexistent_flow(self, client, unique_id):
        """PUT /agents/{id}/skills/{skill_id} возвращает 404 для несуществующего flow."""
        resp = await client.put(
            f"/agents/api/v1/nonexistent_flow/skills/test_skill_{unique_id}",
            json={
                "skill_id": f"test_skill_{unique_id}",
                "name": "Test Skill",
            },
    ...
    @pytest.mark.asyncio
    async def test_delete_skill_valid(self, client, agent_id, unique_id):
        """DELETE /agents/{id}/skills/{skill_id} удаляет skill."""
        skill_id = f"test_skill_delete_{unique_id}"
        ...
        # Удаляем skill
        delete_resp = await client.delete(f"/agents/api/v1/{agent_id}/skills/{skill_id}")
        assert delete_resp.status_code == 200
        data = delete_resp.json()
        assert data["status"] == "success"
        assert data["skill_id"] == skill_id
        
        # Проверяем что skill удалён
        get_resp = await client.get(f"/agents/api/v1/{agent_id}/skills/{skill_id}")
        assert get_resp.status_code == 404

    @pytest.mark.asyncio
    async def test_delete_skill_404_for_nonexistent_skill(self, client, agent_id, unique_id):
        """DELETE /agents/{id}/skills/{skill_id} возвращает 404 для несуществующего skill."""
        resp = await client.delete(f"/agents/api/v1/{agent_id}/skills/nonexistent_skill_{unique_id}")
        assert resp.status_code == 404

    @pytest.mark.asyncio
    async def test_delete_skill_404_for_nonexistent_flow(self, client, unique_id):
        """DELETE /agents/{id}/skills/{skill_id} возвращает 404 для несуществующего flow."""
        resp = await client.delete(f"/agents/api/v1/nonexistent_flow/skills/test_skill_{unique_id}")
        assert resp.status_code == 404

    @pytest.mark.asyncio
    async def test_create_skill_with_edges(self, client, agent_id, unique_id):
        """POST /agents/{id}/skills создаёт skill с edges."""
...
class TestA2AConversation:
    ...
    @pytest.mark.asyncio
    async def test_multi_turn_preserves_context(self, client, agent_id, mock_llm_with_queue, sync_tools):
...
class TestA2AJSONRPCErrors:
    ...
    @pytest.mark.asyncio
    async def test_unknown_method_error(self, client, agent_id):
    ...
    @pytest.mark.asyncio
    async def test_missing_params_error(self, client, agent_id):
    ...
    @pytest.mark.asyncio
    async def test_invalid_message_format_error(self, client, agent_id):
...
class TestA2AEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_empty_message_handled(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_special_characters_handled(self, client, agent_id, mock_llm_with_queue, sync_tools):
...
class TestA2ARealisticStreaming:
    ...
    @pytest.mark.asyncio
    async def test_stream_content_arrives_in_chunks(self, client, agent_id, mock_llm_with_queue, sync_tools):
        """
    ...
    @pytest.mark.asyncio
    async def test_stream_chunks_same_artifact_id(self, client, agent_id, mock_llm_with_queue, sync_tools):
        """Все чанки одного ответа имеют одинаковый artifactId."""
    ...
    @pytest.mark.asyncio
    async def test_stream_last_chunk_marked(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_stream_status_events(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_stream_events_order(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_stream_multi_turn_preserves_streaming(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_stream_task_context_ids_consistent(self, client, agent_id, mock_llm_with_queue, sync_tools):
