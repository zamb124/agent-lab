...
class TestA2AFilesHandling:
    ...
    @pytest.mark.asyncio
    async def test_file_saved_and_in_state(self, client, agent_id, mock_llm_with_queue, sync_tools):
        """
    ...
    @pytest.mark.asyncio
    async def test_file_info_in_content(self, client, agent_id, mock_llm_with_queue, sync_tools):
        """
    ...
    @pytest.mark.asyncio
    async def test_multiple_files(self, client, agent_id, mock_llm_with_queue, sync_tools):
    ...
    @pytest.mark.asyncio
    async def test_message_without_files(self, client, agent_id, mock_llm_with_queue, sync_tools):
...
class TestFileHandlerUnit:
    ...
    def test_extract_and_save_bytes(self, tmp_path):
        ...
        from apps.agents.src.files import FileHandler
    ...
    def test_format_files_for_content(self):
        ...
        from apps.agents.src.files.handler import FileHandler, FileInfo
