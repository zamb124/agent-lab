...
class TestPushNotificationConfig:
    ...
    async def agent_id(self, client):
        resp = await client.get("/agents/api/v1/registry/agents")
        agents = resp.json()
        if not agents:
            pytest.skip("No flows")
        return agents[0]["url"].split("/agents/")[-1]

    @pytest.mark.asyncio
    async def test_set_config_valid_structure(self, client, agent_id, webhook_server):
    ...
    @pytest.mark.asyncio
    async def test_get_config_returns_same_data(self, client, agent_id, webhook_server):
    ...
    @pytest.mark.asyncio
    async def test_list_returns_all_configs(self, client, agent_id, webhook_server):
    ...
    @pytest.mark.asyncio
    async def test_delete_removes_config(self, client, agent_id, webhook_server):
    ...
    @pytest.mark.asyncio
    async def test_config_with_authentication(self, client, agent_id, webhook_server):
...
class TestPushNotificationWebhooks:
    ...
    async def test_webhook_on_completed_has_valid_structure(
        self, client, agent_id, mock_llm_with_queue, webhook_server, sync_tools
    ):
    ...
    async def test_webhook_on_canceled_has_valid_structure(
        ...
        cancel_webhooks = [
            w for w in webhook_server.received_webhooks
...
class TestPushNotificationEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_get_nonexistent_config_returns_null(self, client, agent_id):
    ...
    @pytest.mark.asyncio
    async def test_list_empty_returns_empty_array(self, client, agent_id):
    ...
    @pytest.mark.asyncio
    async def test_delete_nonexistent_is_idempotent(self, client, agent_id):
    ...
    @pytest.mark.asyncio
    async def test_update_config_overwrites(self, client, agent_id, webhook_server):
