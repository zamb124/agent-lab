...
class TestAgentVersionsList:
    ...
    async def test_list_versions_empty_for_new_agent(self, client, unique_id):
        """
        GET /api/v1/agents/{id}/versions возвращает список с одной версией 
        сразу после создания агента.
        """
        agent_id = f"test_versions_list_{unique_id}"
        ...
        resp = await client.get(f"/agents/api/v1/agents/{agent_id}/versions")
    ...
    async def test_multiple_saves_create_multiple_versions(self, client, unique_id):
        ...
        agent_id = f"test_multi_versions_{unique_id}"
        ...
        create_resp = await client.post(
            ...
            json={
                ...
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "Prompt v1"}},
                "edges": [],
            },
        )
        ...
        for i in range(2, 4):
            update_resp = await client.put(
                ...
                json={
                    ...
                    "entry": "main",
                    "nodes": {"main": {"type": "react_node", "prompt": f"Prompt v{i}"}},
                    "edges": [],
                },
            )
    ...
    async def test_list_versions_empty_for_nonexistent_agent(self, client, unique_id):
        """GET /api/v1/agents/{id}/versions для несуществующего агента возвращает пустой список."""
        resp = await client.get(f"/agents/api/v1/agents/nonexistent_{unique_id}/versions")
        assert resp.status_code == 200
        versions = resp.json()
...
class TestAgentGetVersion:
    ...
    async def test_get_specific_version_returns_old_data(self, client, unique_id):
        """
        GET /api/v1/agents/{id}/versions/{version} возвращает данные 
        на момент создания версии.
        """
        agent_id = f"test_get_version_{unique_id}"
        ...
        create_resp = await client.post(
            ...
            json={
                ...
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "Original prompt"}},
                "edges": [],
            },
        )
        assert create_resp.status_code == 200
        ...
        versions_resp = await client.get(f"/agents/api/v1/agents/{agent_id}/versions")
        ...
        await client.put(
            ...
            json={
                ...
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "Updated prompt"}},
                "edges": [],
            },
        )
        
        # Получаем первую версию - должна вернуть оригинальные данные
        version_resp = await client.get(f"/agents/api/v1/agents/{agent_id}/versions/{first_version}")
        ...
        latest_resp = await client.get(f"/agents/api/v1/agents/{agent_id}")
    ...
    async def test_get_version_404_for_nonexistent_version(self, client, unique_id):
        """GET /api/v1/agents/{id}/versions/{version} для несуществующей версии возвращает 404."""
        agent_id = f"test_version_404_{unique_id}"
        ...
        resp = await client.get(f"/agents/api/v1/agents/{agent_id}/versions/99999999999999999999")
    ...
    async def test_get_version_preserves_nodes_and_edges(self, client, unique_id):
        ...
        agent_id = f"test_version_structure_{unique_id}"
        
        # Создаём агента с несколькими нодами
        original_nodes = {
            "start": {"type": "react_node", "prompt": "Start node"},
            "middle": {"type": "react_node", "prompt": "Middle node"},
            "end": {"type": "react_node", "prompt": "End node"},
        }
        original_edges = [
        ...
        await client.put(
            ...
            json={
                ...
                "name": "Simple Agent",
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "Simple"}},
                "edges": [],
            },
        )
...
class TestAgentRollback:
    ...
    async def test_rollback_changes_latest_pointer(self, client, unique_id):
        """POST /api/v1/agents/{id}/versions/{version}/rollback меняет указатель latest."""
        agent_id = f"test_rollback_{unique_id}"
        ...
        await client.post(
            ...
            json={
                ...
                "name": "Version 1",
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "v1"}},
                "edges": [],
            },
        )
        ...
        await client.put(
            ...
            json={
                ...
                "name": "Version 2",
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "v2"}},
                "edges": [],
            },
        )
        
        # Проверяем что latest = v2
        latest_before = await client.get(f"/agents/api/v1/agents/{agent_id}")
        assert latest_before.json()["name"] == "Version 2"
        
        # Откатываем к v1
        rollback_resp = await client.post(
            f"/agents/api/v1/agents/{agent_id}/versions/{v1}/rollback"
        )
        ...
        latest_after = await client.get(f"/agents/api/v1/agents/{agent_id}")
    ...
    async def test_rollback_404_for_nonexistent_version(self, client, unique_id):
        ...
        agent_id = f"test_rollback_404_{unique_id}"
        ...
        resp = await client.post(
            f"/agents/api/v1/agents/{agent_id}/versions/99999999999999999999/rollback"
        )
        assert resp.status_code == 404
    ...
    async def test_rollback_preserves_version_history(self, client, unique_id):
        ...
        agent_id = f"test_rollback_history_{unique_id}"
        ...
        for i in range(2, 4):
            await client.put(
                ...
                json={
                    ...
                    "name": f"v{i}",
                    "entry": "main",
                    "nodes": {"main": {"type": "react_node", "prompt": f"v{i}"}},
                    "edges": [],
                },
            )
        
        versions_before = await client.get(f"/agents/api/v1/agents/{agent_id}/versions")
        ...
        await client.post(f"/agents/api/v1/agents/{agent_id}/versions/{v1}/rollback")
        
        # Количество версий не должно измениться
        versions_after = await client.get(f"/agents/api/v1/agents/{agent_id}/versions")
...
class TestA2AVersionQueryParam:
    ...
    async def test_agent_card_with_version_query(self, client, unique_id):
        """GET /agents/{id}?v=VERSION возвращает карточку конкретной версии."""
        agent_id = f"test_a2a_card_v_{unique_id}"
        ...
        card_v1_resp = await client.get(f"/agents/api/v1/{agent_id}?v={v1}")
        ...
        card_latest_resp = await client.get(f"/agents/api/v1/{agent_id}")
    ...
    async def test_message_send_with_version_query(
        ...
        """POST /agents/{id}?v=VERSION выполняет запрос к конкретной версии."""
        agent_id = f"test_a2a_msg_v_{unique_id}"
        ...
        await client.post(
            ...
            json={
                ...
                "name": "Test Agent",
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "You are v1 agent"}},
                "edges": [],
            },
        )
        ...
        await client.put(
            ...
            json={
                ...
                "name": "Updated Agent",
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "You are v2 agent"}},
                "edges": [],
            },
        )
    ...
    async def test_version_query_nonexistent_returns_jsonrpc_error(self, client, unique_id):
        ...
        agent_id = f"test_a2a_bad_v_{unique_id}"
        ...
        resp = await client.post(
            f"/agents/api/v1/{agent_id}?v=99999999999999999999",
            json={
                "jsonrpc": "2.0",
                "id": "test-bad-version",
                "method": "message/send",
...
class TestA2AVersionMetadata:
    ...
    async def test_message_send_with_version_in_metadata(
        ...
        agent_id = f"test_a2a_meta_v_{unique_id}"
    ...
    async def test_query_param_has_priority_over_metadata(
        ...
        agent_id = f"test_a2a_priority_{unique_id}"
        ...
        versions_resp2 = await client.get(f"/agents/api/v1/agents/{agent_id}/versions")
    ...
    async def test_metadata_version_nonexistent_returns_error(self, client, unique_id):
        ...
        agent_id = f"test_meta_bad_v_{unique_id}"
...
class TestA2AVersionStream:
    ...
    async def test_message_stream_with_version_query(
        ...
        agent_id = f"test_a2a_stream_v_{unique_id}"
        ...
        await client.post(
            ...
            json={
                ...
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "Stream test"}},
                "edges": [],
            },
        )
        ...
        await client.put(
            ...
            json={
                ...
                "entry": "main",
                "nodes": {"main": {"type": "react_node", "prompt": "Updated stream test"}},
                "edges": [],
            },
        )
