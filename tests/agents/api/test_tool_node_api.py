...
class TestCodeNodeFlowAPI:
    ...
    async def test_create_flow_with_existing_tool(self, client, app, unique_id):
        ...
        agent_id = f"test_tool_existing_{unique_id}"
    ...
    async def test_create_flow_with_invalid_tool_id(self, client, app, unique_id):
        ...
        agent_id = f"test_tool_invalid_{unique_id}"
...
class TestAgentWithInlineToolAPI:
    ...
    @pytest.mark.asyncio
    async def test_create_flow_with_react_node_inline_tools(self, client, app, unique_id):
        """Создание flow с react_node и inline tools."""
        agent_id = f"test_agent_inline_tools_{unique_id}"
    ...
    async def test_create_flow_with_mixed_tools(self, client, app, unique_id, auth_headers_system):
        """Создание flow с react_node со смешанными tools."""
        agent_id = f"test_mixed_tools_{unique_id}"
