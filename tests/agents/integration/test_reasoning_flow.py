...
- ReactNodeRunner передает reasoning события
...
class TestReasoningInAgent:
    """Тесты reasoning в flow с react_node."""
    ...
    async def test_flow_with_reasoning_returns_separate_artifacts(
        ...
        agent_id = f"test_reasoning_flow_{unique_id}"

        from apps.agents.src.models import AgentConfig

        container = get_container()
        await container.agent_repository.set(
            AgentConfig(
                agent_id=agent_id,
    ...
    async def test_flow_with_reasoning_only(
        ...
        agent_id = f"test_reasoning_only_flow_{unique_id}"
    ...
    async def test_flow_with_reasoning_and_tool_call(
        ...
        agent_id = f"test_reasoning_tool_flow_{unique_id}"
    ...
    async def test_stream_returns_reasoning_events(
        ...
        agent_id = f"test_reasoning_stream_flow_{unique_id}"
