...
from apps.agents.src.models import AgentConfig, TriggerConfig, TriggerType, TriggerStatus
...
class TestTriggerModels:
    ...
    def test_agent_config_with_triggers(self, unique_id):
        """AgentConfig поддерживает triggers dict."""
        trigger = TriggerConfig(
            trigger_id="tg_main",
            name="Telegram Main",
            type=TriggerType.TELEGRAM,
...
class TestTriggerRegistry:
    ...
    async def test_sync_triggers_registers_new(self, app, container, unique_id):
        ...
        agent_id = f"trigger_test_{unique_id}"
        ...
        new_config = AgentConfig(
            ...
            name="Test Agent",
            entry="main",
            nodes={"main": {"type": "react_node", "prompt": "Test"}},
            triggers={"webhook_1": trigger},
        )
        
        # sync не падает (handler для webhook еще не реализован - будет warning)
        result = await registry.sync_triggers(agent_id, old_config, new_config)
...
class TestTriggersAPI:
    ...
    async def test_list_triggers_empty(self, app, client, container, unique_id):
        """GET /agents/api/v1/agents/{id}/triggers возвращает пустой список."""
        agent_id = f"api_test_{unique_id}"
        ...
        response = await client.get(f"/agents/api/v1/agents/{agent_id}/triggers")
    ...
    async def test_create_trigger(self, app, client, container, unique_id):
        """POST /agents/{id}/triggers создает триггер."""
        agent_id = f"api_test_{unique_id}"
        ...
        response = await client.post(
            f"/agents/api/v1/agents/{agent_id}/triggers",
            json={
        ...
        saved = await container.agent_repository.get(agent_id)
    ...
    async def test_get_trigger(self, app, client, container, unique_id):
        """GET /agents/{id}/triggers/{trigger_id} возвращает триггер."""
        agent_id = f"api_test_{unique_id}"
        ...
        response = await client.get(f"/agents/api/v1/agents/{agent_id}/triggers/my_trigger")
    ...
    async def test_update_trigger(self, app, client, container, unique_id):
        """PUT /agents/{id}/triggers/{trigger_id} обновляет триггер."""
        agent_id = f"api_test_{unique_id}"
        ...
        response = await client.put(
            f"/agents/api/v1/agents/{agent_id}/triggers/update_me",
            json={
                "name": "Updated Name",
                "enabled": False,
            }
    ...
    async def test_delete_trigger(self, app, client, container, unique_id):
        """DELETE /agents/{id}/triggers/{trigger_id} удаляет триггер."""
        agent_id = f"api_test_{unique_id}"
        ...
        response = await client.delete(f"/agents/api/v1/agents/{agent_id}/triggers/delete_me")
    ...
    async def test_test_trigger_endpoint(self, app, client, container, unique_id):
        """POST /agents/{id}/triggers/{trigger_id}/test тестирует маппинг."""
        agent_id = f"api_test_{unique_id}"
        ...
        response = await client.post(
            f"/agents/api/v1/agents/{agent_id}/triggers/test_mapping/test",
            json={
                "message": {
...
class TestTriggerExecutor:
    ...
    async def test_executor_creates_correct_state(self, app, container, unique_id, mock_llm_with_queue):
        ...
        agent_id = f"executor_test_{unique_id}"
...
class TestTelegramWebhookEndpoint:
    ...
    async def test_telegram_webhook_validates_trigger_type(self, app, client, container, unique_id):
        ...
        response = await client.post(
            f"/agents/api/v1/triggers/telegram/{agent_id}/wrong_type",
    ...
    async def test_telegram_webhook_validates_secret_token(self, app, client, container, unique_id):
        ...
        response = await client.post(
            f"/agents/api/v1/triggers/telegram/{agent_id}/tg_secure",
    ...
    async def test_telegram_webhook_404_for_unknown_agent(self, app, client):
        ...
        response = await client.post(
            "/agents/api/v1/triggers/telegram/nonexistent_agent/some_trigger",
            json={"update_id": 123, "message": {"text": "test"}},
        )
    ...
    async def test_telegram_webhook_404_for_unknown_trigger(self, app, client, container, unique_id):
        ...
        response = await client.post(
            f"/agents/api/v1/triggers/telegram/{agent_id}/nonexistent_trigger",
            json={"update_id": 123, "message": {"text": "test"}},
        )
...
class TestTelegramTriggerHandler:
    ...
    async def test_handler_validates_allowed_users(self, app, container, unique_id, mock_llm_with_queue):
        ...
        from apps.agents.src.triggers import TriggerValidationError
        
        mock_llm_with_queue(["Response"])
        
        agent_id = f"tg_handler_{unique_id}"
        ...
        with pytest.raises(TriggerValidationError) as exc_info:
            await handler.handle(agent_id, "allowed_trigger", payload_denied)
    ...
    async def test_handler_validates_commands(self, app, container, unique_id, mock_llm_with_queue):
        ...
        with pytest.raises(TriggerValidationError) as exc_info:
            await handler.handle(agent_id, "cmd_trigger", payload_wrong)
    ...
    def test_handler_generates_webhook_url(self):
        ...
        assert url == "https://example.com/agents/api/v1/triggers/telegram/my_agent/my_trigger"
...
class TestTelegramTriggerE2E:
    ...
    async def test_telegram_webhook_triggers_agent_execution(
        ...
        agent_id = f"tg_e2e_agent_{unique_id}"
        
        # Создаем агента с react_node
        agent = AgentConfig(
            agent_id=agent_id,
...
Отвечай кратко и по делу.""",
        ...
        # Отправляем webhook
        response = await client.post(
            f"/agents/api/v1/triggers/telegram/{agent_id}/telegram_main",
    ...
    async def test_telegram_trigger_with_tool_call(
        ...
        agent_id = f"tg_tool_agent_{unique_id}"
        ...
        response = await client.post(
            f"/agents/api/v1/triggers/telegram/{agent_id}/tg_calc",
            json=telegram_update,
        )
    ...
    async def test_telegram_trigger_filters_by_allowed_users(
        ...
        agent_id = f"tg_filter_agent_{unique_id}"
        ...
        response_allowed = await client.post(
            f"/agents/api/v1/triggers/telegram/{agent_id}/filtered",
            json={
                "update_id": 1,
                "message": {
                    "message_id": 1,
    ...
    async def test_telegram_trigger_filters_by_commands(
        ...
        agent_id = f"tg_cmd_agent_{unique_id}"
        ...
        response_start = await client.post(
            f"/agents/api/v1/triggers/telegram/{agent_id}/commands",
            json={
                "update_id": 1,
                "message": {
                    "message_id": 1,
    ...
    async def test_input_mapping_extracts_all_telegram_fields(
        ...
        agent_id = f"tg_mapping_agent_{unique_id}"
        
        agent = AgentConfig(
            agent_id=agent_id,
            name="Mapping Agent",
            entry="main",
            nodes={"main": {"type": "react_node", "prompt": "Test {{content}}"}},
            triggers={
        ...
        response = await client.post(
            f"/agents/api/v1/agents/{agent_id}/triggers/full_mapping/test",
            json=telegram_update,
        )
...
class TestChannelRegistry:
    ...
    def test_get_telegram_handler(self):
        ...
        from apps.agents.src.channels import create_default_channel_registry, TelegramChannelHandler
        from apps.agents.src.models.enums import ChannelType
...
class TestOutputActionExecutor:
    ...
    async def test_check_condition_true(self):
        ...
        from apps.agents.src.triggers.executor import OutputActionExecutor
...
class TestChannelNode:
    ...
    def test_channel_node_creation(self):
        ...
        from apps.agents.src.agent.nodes import ChannelNode
        from apps.agents.src.models.enums import ChannelType
...
class TestWebhookChannelHandler:
    ...
    async def test_build_headers(self):
        ...
        from apps.agents.src.channels.webhook import WebhookChannelHandler
...
class TestAgentWithChannelNode:
    ...
    async def test_agent_config_with_channel_node(self, unique_id):
        """AgentConfig с ChannelNode валидируется."""
        agent = AgentConfig(
            agent_id=f"channel_agent_{unique_id}",
...
class TestTriggerWithOutputActionsE2E:
    ...
    async def test_agent_with_trigger_output_actions(self, unique_id):
        ...
        agent_id = f"output_agent_{unique_id}"
        ...
        loaded = await container.agent_repository.get(agent_id)
...
class TestTelegramChannelE2E:
    ...
    async def test_telegram_send_message_real_http(self, notification_server):
        ...
        from apps.agents.src.channels.telegram import TelegramChannelHandler
...
class TestChannelNodeE2E:
    ...
    async def test_channel_node_sends_webhook_notification(
        ...
        agent_id = f"channel_e2e_{unique_id}"
...
""",
        ...
        agent = await container.agent_factory.get_flow(agent_id)
        
        # session_id должен быть в формате agent_id:context_id
    ...
    async def test_channel_node_sends_telegram_message(
        ...
        agent_id = f"tg_channel_e2e_{unique_id}"
        context_id = f"ctx_{unique_id}"
...
class TestTriggerOutputActionsE2E:
    ...
    async def test_trigger_output_action_sends_webhook(
        ...
        agent_id = f"output_action_e2e_{unique_id}"
    ...
    async def test_trigger_multiple_output_actions(
        ...
        agent_id = f"multi_output_e2e_{unique_id}"
    ...
    async def test_output_action_with_condition_executes(
        ...
        agent_id = f"conditional_e2e_{unique_id}"
        ...
        agent_config = AgentConfig(
            ...
            entry="main",
            nodes={"main": {"type": "react_node", "prompt": "Answer."}},
...
class TestFullTriggerFlowE2E:
    ...
    async def test_full_telegram_trigger_webhook_to_agent(
        ...
        1. Telegram webhook приходит на /triggers/telegram/{agent_id}/{trigger_id}
        ...
        agent_id = f"full_flow_e2e_{unique_id}"
        trigger_id = "tg_full"
        ...
        response = await client.post(
            f"/agents/api/v1/triggers/telegram/{agent_id}/{trigger_id}",
    ...
    async def test_code_agent_with_channel_node_full_flow(
        ...
        agent_id = f"code_channel_e2e_{unique_id}"
        context_id = f"ctx_{unique_id}"
...
class TestReactAgentWithChannelToolE2E:
    """
    E2E тесты: ReactNode с ChannelNode как tool.
    ...
    async def test_react_agent_uses_channel_tool_to_send_webhook(
        ...
        """
        ReactNode агент с ChannelNode tool:
        ...
        agent_id = f"react_channel_tool_{unique_id}"
        context_id = f"ctx_{unique_id}"
        ...
        # ReactNode агент с ChannelNode как tool
        agent_config = AgentConfig(
            agent_id=agent_id,
    ...
    async def test_react_agent_uses_telegram_channel_tool(
        ...
        """
        ReactNode с Telegram ChannelNode tool:
        ...
        agent_id = f"react_tg_tool_{unique_id}"
        context_id = f"ctx_{unique_id}"
...
class TestFullWebhookToChannelE2E:
    """
    Полный E2E flow: Telegram Webhook → ReactNode → ChannelNode tool → HTTP.
    ...
    async def test_telegram_webhook_triggers_react_agent_which_sends_webhook(
        ...
        Полный flow:
        1. Telegram webhook приходит на /triggers/telegram/{agent_id}/{trigger_id}
        2. ReactNode агент получает message.text
        ...
        agent_id = f"full_webhook_e2e_{unique_id}"
    ...
    async def test_telegram_webhook_triggers_react_agent_which_replies_to_telegram(
        ...
        agent_id = f"tg_reply_e2e_{unique_id}"
