...
class TestAuthHeadersWithNestedVars:
    ...
    def test_remote_agent_resolve_value_simple(self):
    ...
    def test_remote_agent_resolve_value_nested(self):
    ...
    def test_remote_agent_resolve_auth_headers(self):
    ...
    def test_remote_agent_url_with_nested_var(self):
...
class TestExternalAPIClientAuthHeaders:
    ...
    def test_build_headers_with_nested_vars(self):
        ...
        from apps.agents.src.clients.external_api_client import ExternalAPIClient
        from apps.agents.src.models.external_api import ExternalAPIConfig, HTTPMethod
