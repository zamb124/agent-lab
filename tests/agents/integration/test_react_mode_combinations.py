"""
СТРОГИЕ тесты комбинаций режимов ReactNode.
...
class TestAutoModeWithoutReason:
    ...
    async def test_text_response_exits_immediately(
        ...
        agent_id = f"auto_no_reason_text_{unique_id}"
    ...
    async def test_tool_then_text_exits(
        ...
        agent_id = f"auto_no_reason_tool_{unique_id}"
        container = get_container()
    ...
    async def test_multiple_tools_then_text_exits(
        ...
        agent_id = f"auto_no_reason_multi_{unique_id}"
        container = get_container()
...
class TestAutoModeWithReason:
    ...
    async def test_reason_then_text_exits(
        ...
        agent_id = f"auto_reason_text_{unique_id}"
        container = get_container()
    ...
    async def test_multiple_reasons_then_text_exits(
        ...
        agent_id = f"auto_multi_reason_{unique_id}"
        container = get_container()
    ...
    async def test_reason_only_then_text_exits(
        ...
        agent_id = f"auto_reason_only_{unique_id}"
        container = get_container()
...
class TestExplicitModeWithExitOnly:
    ...
    async def test_exit_tool_exits(
        ...
        agent_id = f"explicit_exit_only_{unique_id}"
        container = get_container()
    ...
    async def test_tool_then_exit_exits(
        ...
        agent_id = f"explicit_tool_exit_{unique_id}"
        container = get_container()
    ...
    async def test_text_without_exit_adds_reminder(
        ...
        agent_id = f"explicit_text_reminder_{unique_id}"
        container = get_container()
    ...
    async def test_multiple_tools_then_exit(
        ...
        agent_id = f"explicit_multi_tool_exit_{unique_id}"
        container = get_container()
...
class TestExplicitModeWithReasonAndExit:
    ...
    async def test_reason_then_exit_exits(
        ...
        agent_id = f"explicit_reason_exit_{unique_id}"
        container = get_container()
    ...
    async def test_reason_tool_then_exit_exits(
        ...
        agent_id = f"explicit_reason_tool_exit_{unique_id}"
        container = get_container()
    ...
    async def test_text_with_reason_still_needs_exit(
        ...
        agent_id = f"explicit_reason_text_exit_{unique_id}"
        container = get_container()
...
class TestCustomReasonAndExitTools:
    ...
    async def test_custom_reason_tool_works(
        ...
        agent_id = f"custom_reason_{unique_id}"
        container = get_container()
    ...
    async def test_custom_exit_tool_works(
        ...
        agent_id = f"custom_exit_{unique_id}"
        container = get_container()
    ...
    async def test_custom_reason_and_exit_together(
        ...
        agent_id = f"custom_both_{unique_id}"
        container = get_container()
...
class TestEdgeCases:
    ...
    async def test_empty_tools_auto_mode(
        ...
        agent_id = f"edge_empty_tools_{unique_id}"
        container = get_container()
    ...
    async def test_exit_tool_auto_injected_in_explicit(
        ...
        agent_id = f"edge_auto_inject_{unique_id}"
        container = get_container()
    ...
    async def test_strict_false_allows_text_exit(
        ...
        agent_id = f"edge_strict_false_{unique_id}"
        container = get_container()
    ...
    async def test_reason_without_other_actions_then_text(
        ...
        agent_id = f"edge_reason_alone_{unique_id}"
        container = get_container()
...
class TestExplicitModeStreaming:
    ...
    async def test_text_artifacts_not_streamed_before_exit_tool(
        ...
        from apps.agents.src.models.node_config import NodeConfig, NodeLLMOverride, ReactConfig
        from apps.agents.src.models import ReactLoopMode
        from apps.agents.src.tools.base import InlineTool
        from apps.agents.src.models.tool_reference import CallParameter

        agent_id = f"explicit_streaming_{unique_id}"
        container = get_container()
    ...
    async def test_auto_mode_streams_text_artifacts(
        ...
        agent_id = f"auto_streaming_{unique_id}"
