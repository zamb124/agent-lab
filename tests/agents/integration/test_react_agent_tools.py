...
class TestInlineReactAgentWithTools:
    ...
    async def test_inline_agent_executes_inline_tool(
        ...
        agent_id = f"test_inline_tool_{unique_id}"
    ...
    async def test_inline_agent_executes_node_as_tool(
        ...
        """
        agent_id = f"test_node_tool_{unique_id}"
        container = get_container()
        ...
        agent = await factory.get_flow(agent_id)
        state = ExecutionState(
            task_id="test-task",
            context_id="test-context",
            user_id="test-user",
    ...
    async def test_inline_agent_executes_db_inline_tool(
        ...
        """
        agent_id = f"test_db_inline_{unique_id}"
        ...
        factory = container.agent_factory
        flow = await factory.get_flow(agent_id)
        state = ExecutionState(
            task_id="test-task",
            context_id="test-context",
            user_id="test-user",
    ...
    async def test_inline_agent_executes_mixed_tools(
        ...
        """
        agent_id = f"test_mixed_{unique_id}"
...
class TestToolExecutionResults:
    ...
    async def test_inline_tool_returns_correct_result(
        ...
        """
        agent_id = f"test_result_{unique_id}"
...
"""
    ...
    async def test_tool_receives_state(
        ...
        """
        agent_id = f"test_state_{unique_id}"
...
"""
    ...
    async def test_multiple_tool_calls_in_sequence(
        ...
        """
        agent_id = f"test_sequence_{unique_id}"
