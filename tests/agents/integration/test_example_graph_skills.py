...
class TestFastTrackSkill:
    ...
    async def flow(self, app):
        ...
        return await container.agent_factory.get_flow("example_graph", skill_id="fast_track")

    @pytest.mark.asyncio
    async def test_flow_created_with_skill(self, flow):
        """Agent создается с fast_track skill."""
        assert flow is not None
        assert flow.agent_id == "example_graph"
    ...
    async def test_route_greeting_in_fast_track(self, app):
        ...
        container = get_container()
        agent = await container.agent_factory.get_flow("example_graph", skill_id="fast_track")
...
class TestOrdersOnlySkill:
    ...
    async def flow(self, app):
        ...
        container = get_container()
        return await container.agent_factory.get_flow("example_graph", skill_id="orders_only")
...
class TestFunctionNodesSkill:
    ...
    async def flow(self, app):
        ...
        container = get_container()
        return await container.agent_factory.get_flow("example_graph", skill_id="test_function_nodes")
    ...
    async def test_classifier_routes_correctly(self, app, mock_llm_with_queue):
        ...
        container = get_container()
        flow = await container.agent_factory.get_flow("example_graph", skill_id="test_function_nodes")
...
class TestReactNodesSkill:
    """
    Тесты для skill 'test_react_nodes'.
    ...
    @pytest_asyncio.fixture
    async def flow(self, app):
        """Загружает flow с test_react_nodes skill."""
        container = get_container()
        return await container.agent_factory.get_flow("example_graph", skill_id="test_react_nodes")

    @pytest.mark.asyncio
    async def test_flow_created_with_skill(self, flow):
        """Agent создается с test_react_nodes skill."""
        assert flow is not None
    ...
    async def test_order_processor_executes(self, app, mock_llm_with_queue):
        ...
        container = get_container()
        flow = await container.agent_factory.get_flow("example_graph", skill_id="test_react_nodes")
...
class TestLlmGraphSkill:
    ...
    async def flow(self, app):
        ...
        container = get_container()
        return await container.agent_factory.get_flow("example_graph", skill_id="test_llm_graph")
    ...
    async def test_all_routes_execute_correctly(
        ...
        container = get_container()
        flow = await container.agent_factory.get_flow("example_graph", skill_id="test_llm_graph")
...
class TestRouteOrderSkill:
    ...
    async def flow(self, app):
        ...
        container = get_container()
        return await container.agent_factory.get_flow("example_graph", skill_id="test_route_order")
    ...
    async def test_order_route_executes(self, app, mock_llm_with_queue):
        ...
        container = get_container()
        flow = await container.agent_factory.get_flow("example_graph", skill_id="test_route_order")
...
class TestRouteComplaintSkill:
    ...
    async def flow(self, app):
        ...
        container = get_container()
        return await container.agent_factory.get_flow("example_graph", skill_id="test_route_complaint")
    ...
    async def test_complaint_route_executes(self, app, mock_llm_with_queue):
        ...
        container = get_container()
        flow = await container.agent_factory.get_flow("example_graph", skill_id="test_route_complaint")
...
class TestFullGraphSkill:
    ...
    async def flow(self, app):
        ...
        container = get_container()
        return await container.agent_factory.get_flow("example_graph", skill_id="test_full_graph")
    ...
    async def test_full_graph_execution(self, app, mock_llm_with_queue):
        ...
        container = get_container()
        flow = await container.agent_factory.get_flow("example_graph", skill_id="test_full_graph")
...
class TestDefaultSkill:
    ...
    async def flow(self, app):
        ...
        container = get_container()
        return await container.agent_factory.get_flow("example_graph")
    ...
    @pytest.mark.asyncio
    async def test_cat_route_goes_to_cat_fact_api(self, app):
...
class TestSkillStatePreservation:
    ...
    async def test_variables_available_in_all_skills(self, app, mock_llm_with_queue):
        ...
        for skill_id in ["fast_track", "orders_only", "test_function_nodes"]:
            flow = await container.agent_factory.get_flow("example_graph", skill_id=skill_id)
...
class TestSkillEdgeCases:
    ...
    async def test_nonexistent_skill_falls_back_to_default(self, app, mock_llm_with_queue):
        ...
        container = get_container()
        flow = await container.agent_factory.get_flow("example_graph", skill_id="nonexistent_skill")
