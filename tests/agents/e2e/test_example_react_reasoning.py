...
class TestExampleReactReasoning:
    ...
    async def test_subagent_with_reasoning_returns_artifacts(
        ...
        субагент example_subagent имеет reasoning: {enabled: true}.
        """
        mock_llm_with_queue([
            # Main нода вызывает example_subagent
            {
                "type": "tool_call",
                "tool": "example_subagent",
                "args": {"query": "Привет!"},
            },
            # example_subagent вызывает reasoning tool
            {
                "type": "tool_call",
                "tool": "reason",
                "args": {
            ...
            # example_subagent отвечает после reasoning
