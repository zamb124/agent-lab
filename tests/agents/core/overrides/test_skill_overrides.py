...
import pytest
from apps.agents.src.models import AgentConfig, Edge, MergeMode, SkillConfig
...
class TestSkillVariablesOverride:
    ...
    def test_variables_merge_adds_new(self, container):
        ...
        result = container.agent_factory._apply_skill(config, "custom")
    ...
    def test_variables_with_agent_variable_config(self, container):
        """Переменные в формате AgentVariableConfig мержатся корректно."""
        config = AgentConfig(
            agent_id="test_vars",
            name="Test",
            entry="main",
...
class TestSkillNodesOverride:
        ...
        config = AgentConfig(
            ...
            skills={
                "custom": SkillConfig(
                    ...
                    entry="custom_main",
                    nodes={
                        "custom_main": {"type": "react_node", "prompt": "Custom"}
                    },
    ...
    def test_nodes_merge_adds_new(self, container):
        ...
        config = AgentConfig(
            ...
            entry="main",
            nodes={
                "main": {"type": "react_node", "prompt": "Base"}
            },
            edges=[Edge(from_node="main", to_node=None)],
            skills={
                "custom": SkillConfig(
    ...
    def test_nodes_merge_deep_merges_existing(self, container):
        ...
        assert node["type"] == "react_node"  # Сохранен
...
class TestSkillMockOverride:
    ...
    def test_mock_enabled_in_skill(self):
        """Skill включает mock."""
        from apps.agents.src.mock.resolver import resolve_mock_config
    ...
    def test_mock_agents_in_skill(self):
        ...
        assert config.agents["subagent"] == "Mocked subagent response"
...
class TestSkillCombinedOverrides:
    ...
    def test_full_skill_override(self, container):
        ...
        config = AgentConfig(
            ...
            skills={
                "full": SkillConfig(
                    ...
                    entry="custom_entry",
                    nodes={
                        "custom_entry": {"type": "react_node", "prompt": "Custom", "tools": ["t2"]}
                    },
                    nodes_mode=MergeMode.REPLACE,
        ...
        result = container.agent_factory._apply_skill(config, "full")
    ...
    def test_example_react_concise_skill(self, container):
        ...
        config = AgentConfig(
            agent_id="example_react_test",
            name="Example React",
            entry="main",
            nodes={
                "main": {"type": "react_node", "node_id": "example_main_agent"}
            },
            edges=[Edge(from_node="main", to_node=None)],
            variables={
        ...
        result = container.agent_factory._apply_skill(config, "concise")
    ...
    def test_example_graph_orders_only_skill(self, container):
        ...
        config = AgentConfig(
            ...
            nodes={
                ...
                "complaint_processor": {"type": "react_node", "prompt": "Complaint"},
                "general_processor": {"type": "react_node", "prompt": "General"}
            },
            edges=[
        ...
        result = container.agent_factory._apply_skill(config, "orders_only")
