...
from apps.agents.src.tools.base import BaseTool, is_test_mode
from apps.agents.src.agent.exceptions import AgentInterrupt
from core.state import ExecutionState
from apps.agents.tools import calculator, finish, ask_user
...
class TestAskUserTool:
    ...
    async def test_ask_user_raises_interrupt(self):
        """ask_user всегда кидает AgentInterrupt."""
        state = ExecutionState(
            task_id="test-task",
            context_id="test-context",
            user_id="test-user",
