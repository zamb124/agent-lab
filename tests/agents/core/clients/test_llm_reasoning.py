...
from apps.agents.src.channels.a2a import _build_task_from_events
...
class TestReasoningArtifactsInBuildTask:
    ...
    async def test_build_task_separates_reasoning_and_response(self, app):
        ...
        task = await _build_task_from_events(events, task_id, context_id, input_message, agent_id="test_flow")
