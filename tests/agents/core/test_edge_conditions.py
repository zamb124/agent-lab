...
class TestLegacyStringConditions:
    ...
    async def test_string_condition_equals_string(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.route = 'order'; return state"},
                "order": {"type": "function", "code": "def run(state): state.result = 'order_node'; return state"},
            },
            "edges": [
    ...
    async def test_string_condition_equals_number(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.count = 5; return state"},
                "five": {"type": "function", "code": "def run(state): state.result = 'five'; return state"},
            },
            "edges": [
    ...
    async def test_string_condition_not_equals(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.status = 'ok'; return state"},
                "proceed": {"type": "function", "code": "def run(state): state.result = 'proceeded'; return state"},
            },
            "edges": [
    ...
    async def test_string_condition_greater_than(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.score = 85; return state"},
                "pass": {"type": "function", "code": "def run(state): state.result = 'passed'; return state"},
            },
            "edges": [
    ...
    async def test_string_condition_nested_field(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.user = {'role': 'admin'}; return state"},
                "admin": {"type": "function", "code": "def run(state): state.result = 'admin_access'; return state"},
            },
            "edges": [
    ...
    async def test_string_condition_false_no_transition(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.route = 'other'; return state"},
                "order": {"type": "function", "code": "def run(state): state.result = 'order_node'; return state"},
            },
            "edges": [
                {"from": "start", "to": "order", "condition": "route == 'order'"}
...
class TestSimpleObjectConditions:
    ...
    async def test_simple_equals(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.route = 'complaint'; return state"},
                "complaint": {"type": "function", "code": "def run(state): state.result = 'complaint_handler'; return state"},
            },
            "edges": [
                {
                    "from": "start", 
    ...
    async def test_simple_not_equals(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.status = 'active'; return state"},
                "proceed": {"type": "function", "code": "def run(state): state.result = 'ok'; return state"},
            },
            "edges": [
                {
                    "from": "start", 
    ...
    async def test_simple_greater_than(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.priority = 10; return state"},
                "high": {"type": "function", "code": "def run(state): state.result = 'high_priority'; return state"},
            },
            "edges": [
                {
                    "from": "start", 
    ...
    async def test_simple_less_or_equal(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.count = 2; return state"},
                "few": {"type": "function", "code": "def run(state): state.result = 'few_items'; return state"},
            },
            "edges": [
                {
                    "from": "start", 
...
class TestPythonConditions:
    ...
    async def test_python_simple_check(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.category = 'urgent'; return state"},
                "urgent": {"type": "function", "code": "def run(state): state.result = 'urgent_handler'; return state"},
            },
            "edges": [
                {
                    "from": "start", 
    ...
    async def test_python_complex_logic(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.score = 85; state.verified = True; return state"},
                "approved": {"type": "function", "code": "def run(state): state.result = 'approved'; return state"},
            },
            "edges": [
                {
                    "from": "start", 
...
"""
    ...
    async def test_python_with_list_check(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.tags = ['vip', 'premium']; return state"},
                "vip": {"type": "function", "code": "def run(state): state.result = 'vip_treatment'; return state"},
            },
            "edges": [
                {
                    "from": "start", 
    ...
    async def test_python_condition_returns_false(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.value = 10; return state"},
                "target": {"type": "function", "code": "def run(state): state.result = 'reached'; return state"},
            },
            "edges": [
                {
                    "from": "start", 
    ...
    async def test_python_invalid_code_returns_false(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): return state"},
                "target": {"type": "function", "code": "def run(state): state.result = 'reached'; return state"},
            },
            "edges": [
                {
...
class TestUnconditionalEdges:
    ...
    async def test_edge_without_condition(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "nodes": {
                "start": {"type": "function", "code": "def run(state): return state"},
                "next": {"type": "function", "code": "def run(state): state.result = 'next_executed'; return state"},
            },
            "edges": [
                {"from": "start", "to": "next"}
            ]
    ...
    async def test_edge_with_null_condition(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "nodes": {
                "start": {"type": "function", "code": "def run(state): return state"},
                "next": {"type": "function", "code": "def run(state): state.result = 'executed'; return state"},
            },
            "edges": [
...
class TestMultipleEdges:
    ...
    async def test_first_matching_condition_wins(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.route = 'order'; return state"},
                "order": {"type": "function", "code": "def run(state): state.result = 'order_handler'; return state"},
                "complaint": {"type": "function", "code": "def run(state): state.result = 'complaint_handler'; return state"},
            },
            "edges": [
                {"from": "start", "to": "order", "condition": "route == 'order'"},
    ...
    async def test_fallback_edge_without_condition(self, app):
        ...
        agent = await Agent.from_config({
            ...
            "entry": "start",
            "nodes": {
                "start": {"type": "function", "code": "def run(state): state.route = 'unknown'; return state"},
                "known": {"type": "function", "code": "def run(state): state.result = 'known'; return state"},
                "fallback": {"type": "function", "code": "def run(state): state.result = 'fallback'; return state"},
            },
            "edges": [
