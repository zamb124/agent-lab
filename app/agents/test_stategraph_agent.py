...
test_stategraph_agent_config = AgentConfig(
    agent_id="app.agents.test_stategraph_agent.test_stategraph_agent_config",
    ...
    graph_definition=GraphDefinition(
        nodes=[
            ...
            GraphNode(
                ...
                code_mode=CodeMode.CODE_REFERENCE,
                function_path="app.agents.test_stategraph_agent.greeting_function",
                params={
...
""",
            ...
            GraphNode(
                ...
                type=NodeType.FUNCTION_NODE,
                code_mode=CodeMode.CODE_REFERENCE,
                function_path="app.agents.test_stategraph_agent.process_data_function",
                params={
...
""",
            ...
            GraphNode(
                ...
                type=NodeType.FUNCTION_NODE,
                code_mode=CodeMode.CODE_REFERENCE,
                function_path="app.agents.test_stategraph_agent.final_function",
                params={
        ...
        edges=[
            ...
            GraphEdge(
                source="router",
                target="process_data",
                condition="app.agents.test_stategraph_agent.router_condition",
