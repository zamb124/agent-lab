...
window.openPaymentModal = () => billingManager.openPaymentModal();
window.closePaymentModal = () => billingManager.closePaymentModal();
window.createPayment = () => billingManager.handleCreatePayment();

window.addEventListener('beforeunload', () => {
    billingManager.stopStatsRefresh();
});
