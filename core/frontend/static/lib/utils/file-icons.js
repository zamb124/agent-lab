/**
 * Чистые утилиты для типов файлов: alias-таблицы, MIME-резолверы.
 *
...
export const UI_ICON_MAP = Object.freeze({
    ...
    radio: 'radio', stream: 'radio', streaming: 'radio',
    split: 'swap-horiz', 'file-json': 'trace-json',
    ...
    'git-compare': 'swap-horiz',
    activity: 'chart',
    shield: 'user-shield',
    sparkles: 'sparkle',
    'messages-square': 'chat',
    'badge-check': 'check-square',
    'file-pen': 'edit',
    'search-check': 'search',
    braces: 'code',
    table: 'list',
    flag: 'target',
    history: 'schedule',
    'message-square-plus': 'chat',
    'circle-dot': 'fiber-manual-record',
