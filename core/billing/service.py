...
class BillingService:
    ...
    def __init__(
        ...
        self.tariff_prices = tariff_prices or DEFAULT_TARIFF_PRICES
        
        # Базовые цены ресурсов по категориям
        self.resource_base_prices = resource_base_prices or {
            "llm": {
    ...
    async def get_resource_cost_for_company(self, company: Company, resource_name: str) -> float:
        ...
        category_prices = self.resource_base_prices.get(category, {})
        ...
        tariff_prices = self.tariff_prices.get(company.tariff_plan, {})
    ...
    async def get_company_usage_stats(self, company_id: str) -> Dict[str, Any]:
        ...
        if user_ids:
            users_dict = await self.user_repository.get_many(list(user_ids))
