...
ROUTE_RULES: List[RouteRule] = [
    ...
    RouteRule("/api/companies/*/pronunciation-rules/*", context_type="api", auth_required=True),
    RouteRule("/frontend/api/companies/*/pronunciation-rules", context_type="api", auth_required=True),
    RouteRule("/frontend/api/companies/*/pronunciation-rules/*", context_type="api", auth_required=True),
    RouteRule("/*/api/companies/*/pronunciation-rules", context_type="api", auth_required=True),
    RouteRule("/*/api/companies/*/pronunciation-rules/*", context_type="api", auth_required=True),
...
NO_SUBDOMAIN_ALLOWED_PATHS = [
    ...
    "/*/api/companies/*/voice-providers",
    "/*/api/companies/*/voice-providers/*",
    "/api/companies/*/pronunciation-rules",
    "/api/companies/*/pronunciation-rules/*",
    "/frontend/api/companies/*/pronunciation-rules",
    "/frontend/api/companies/*/pronunciation-rules/*",
    "/*/api/companies/*/pronunciation-rules",
    "/*/api/companies/*/pronunciation-rules/*",
    "/frontend/api/platform/pronunciation-rules",
    "/frontend/api/platform/pronunciation-rules/*",
    "/api/invites/accept",
