...
class VariablesService:
    ...
    async def set_var(
        ...
        result = await self.variable_repository.set(variable)
    ...
    async def get_var(self, key: str, create_if_missing: bool = False) -> Optional[str]:
        ...
        Returns:
            Значение или None
        """
        variable = await self.variable_repository.get(key)
    ...
    async def delete_var(self, key: str) -> bool:
        ...
        return await self.variable_repository.delete(key)
    
    async def list_vars(self) -> Dict[str, Any]:
        """Получает все переменные компании"""
        all_variables = await self.variable_repository.get_all_variables()
    ...
    async def add_tag_to_variable(self, var_key: str, tag: str) -> bool:
        ...
        if tag not in variable.groups:
            ...
            await self.variable_repository.set(variable)
