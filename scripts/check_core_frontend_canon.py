...
Зоны:
  ...
  components/**   — UI Kit; extends ТОЛЬКО PlatformElement / PlatformModal /
                    PlatformFormModal / PlatformLightModal. Каждая модалка
...
def check_components_zone() -> None:
    ...
    # registerModalKind. Базовые модалки UI Kit (glass-modal/...-form-modal/..-light-modal,
    # platform-modal-stack, platform-confirm-modal — абстрактный базовый класс
    # для apps), а также legacy-модалки в процессе миграции — исключены.
    base_modals = {
        "glass-modal.js",
        "glass-form-modal.js",
        "glass-light-modal.js",
