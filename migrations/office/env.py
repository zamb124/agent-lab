"""
Alembic env для БД сервиса office (привязки документов OnlyOffice).
"""
...
from apps.office.db.models import (  # noqa: F401
    OfficeCatalogMember,
...
def _get_url() -> str:
    ...
    if not settings.database.office_url:
        raise ValueError("DATABASE__OFFICE_URL не настроен")
    return settings.database.office_url
