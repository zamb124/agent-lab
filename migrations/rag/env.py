"""
Alembic env для rag БД.

Управляет таблицами: document_processing_status, vector_documents.
"""
...
MANAGED_TABLES = {"document_processing_status", "vector_documents"}
...
def _get_url() -> str:
    ...
    return settings.database.rag_url
