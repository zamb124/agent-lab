"""Возврат embedding vector(1024) и HNSW (семантический ANN).

Размерность 4096 снимала индекс из‑за лимита pgvector HNSW; перевекторизация после upgrade —
эмбеддинги обнуляются (USING NULL).
...
down_revision: Union[str, None] = "rag_0004"
