"""CRM vector_documents: embedding vector(4096), колонка embedding_model.

Индекс HNSW по embedding не создаётся из‑за лимита pgvector на размерность HNSW (2000).

Revision ID: crm_0021
Revises: crm_0020
...
revision: str = "crm_0021"
down_revision: Union[str, None] = "crm_0020"
