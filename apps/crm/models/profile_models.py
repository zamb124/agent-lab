...
class WidgetConfig(BaseModel):
    ...
    enabled_widgets: list[str] = Field(
        default_factory=lambda: ["tasks", "notes", "calendar"], title="Включенные виджеты"
    )
    layout: JsonObject = Field(default_factory=dict, title="Расположение виджетов")
...
class UserProfileCreate(BaseModel):
    ...
    user_id: str | None = Field(default=None, max_length=100, title="ID пользователя")
    display_name: str | None = Field(default=None, max_length=100, title="Отображаемое имя")
    position: str | None = Field(default=None, max_length=100, title="Должность")
    avatar_url: str | None = Field(default=None, max_length=500, title="URL аватара")
    phone: str | None = Field(default=None, max_length=50, title="Телефон")
    bio: str | None = Field(default=None, max_length=500, title="О себе")
    telegram_username: str | None = Field(default=None, max_length=100, title="Telegram username")
    sidebar_config: JsonObject | None = Field(default=None, title="Настройки sidebar")
    widget_config: JsonObject | None = Field(default=None, title="Настройки виджетов")
...
class UserProfileResponse(BaseModel):
    ...
    sidebar_config: JsonObject = Field(default_factory=dict, title="Настройки sidebar")
    widget_config: JsonObject = Field(default_factory=dict, title="Настройки виджетов")
