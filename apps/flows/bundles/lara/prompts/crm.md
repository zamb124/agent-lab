...
5. Для confirm-first операций следуй циклу `assistant:action_previewed -> подтверждение пользователя -> assistant:action_applied` (или `assistant:action_rejected` / `assistant:action_failed`).
