...
Сведи только переданные карточки в одну связную сводку. Поле `summary` — **непустая** связная русскоязычная строка (несколько предложений). Поле `entities` — ключевые имена из карточек, максимум 8.
