...
Убери дубли, выдели главное за день. Поле `summary` — **непустая** итоговая русскоязычная строка по всем промежуточным сводкам. Поле `entities` — объединённый список уникальных имён, максимум 8.
