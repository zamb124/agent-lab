...
function renderZoomControls(component) {
    return html`
        <div class="zoom-controls">
            <button class="zoom-btn" @click=${component._zoomIn} title=${component.i18n.t('toolbar.zoom_in')}>
                <platform-icon name="plus" size="16"></platform-icon>
            </button>
            <button class="zoom-btn" @click=${component._zoomOut} title=${component.i18n.t('toolbar.zoom_out')}>
                <platform-icon name="minus" size="16"></platform-icon>
            </button>
            <button class="zoom-btn" @click=${component._zoomReset} title=${component.i18n.t('toolbar.zoom_reset')}>
