...
# Graph endpoints ДОЛЖНЫ быть ПЕРЕД общими {agent_id:path} роутами
# иначе path parameter перехватит /graph как часть agent_id
...
# Общие CRUD эндпоинты с {agent_id:path} должны быть ПОСЛЕ специфичных роутов
