...
from core.models.mcp_models import MCPServerConfig

from core.db.storage.mcp_repository import MCPServerRepository
from core.mcp_sync import sync_mcp_server_tools

router = APIRouter(prefix="/api/v1/mcp", tags=["MCP"])


@router.get("/servers")
async def list_mcp_servers() -> List[MCPServerConfig]:
...
async def get_mcp_server(server_id: str) -> MCPServerConfig:
