...
class CanvasService:
    ...
    def flow_repository(self):
        if self._flow_repository is None:
            ...
            self._flow_repository = get_agents_container().flow_repository
    ...
    async def update_agents_from_canvas(self, canvas_data: Dict[str, Any]):
        ...
        from apps.agents.models import AgentType, GraphDefinition, GraphNode, GraphEdge
        ...
        if entry_point_agent.type == AgentType.STATEGRAPH:
            ...
            await self.agent_repository.set(entry_point_agent)
