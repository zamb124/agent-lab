    ...
    constructor() {
        ...
        this.faqItems = [
            ...
            },
            {
                ...
                answer: 'Нет. Все сервисы имеют простой визуальный интерфейс. Создание агента, загрузка документов в базу знаний, ведение записей в NetWorkle — всё делается через понятные формы без программирования. Для сложных задач есть тариф с поддержкой, где наша команда поможет настроить всё под ваши процессы.',
                open: false
            }
        ];
    }
