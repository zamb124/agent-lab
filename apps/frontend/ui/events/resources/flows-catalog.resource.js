/**
 * Op каталога flows — каталог flows и tools для выбора в embed/scheduler модалках.
 *
 ...
 * Локальный flow в items есть branches (ветки/skill); embed-модалка выбирает branch_id.
 *
...
export const flowsCatalogOp = createAsyncOp({
    ...
    silent: true,
    // Межсервисный вызов: составной запрос /flows/api/v1/flows/ + /tools/.
