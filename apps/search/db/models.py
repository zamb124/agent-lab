...
class CrawlProfileRow(Base):
    ...
    include_url_patterns: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list)
    exclude_url_patterns: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list)
    exclude_extensions: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list)
