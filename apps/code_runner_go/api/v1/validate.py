"""HTTP API code-runner-go validation."""

import traceback

from fastapi import APIRouter

from apps.code_runner_go.dependencies import ContainerDep
from apps.code_runner_go.services.executor import SERVICE_NAME
