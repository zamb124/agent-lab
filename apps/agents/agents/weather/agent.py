...
from apps.agents.tools.misc.weather_tools import suggest_travel, get_weather
from apps.agents.tools.files.file_tools import read_file
from apps.agents.tools.voice.voice_tools import synthesize_speech
from apps.agents.tools.integrations.nano_banana_tools import generate_images
from apps.agents.tools.misc.rag_tools import search_knowledge_base, list_documents_in_knowledge_base
...
ВСЕГДА ОТВЕЧАеШЬ С ПОМОЩЬЮ ack_user ТОЛЬКО КОГДА ТЕБЕ УЖЕ НЕЧЕГО СКАЗАТЬ ОТВЕЧАЕШЬ БЕЗ ФУНКЙИИ!!!!!!!
...
"""
    ...
    tools = [ask_user, read_file, "apps.agents.tools.session.session_tools.session_set"]
...
"""
    ...
    tools = [
        ...
        read_file,
        synthesize_speech,
        "agent:apps.agents.agents.weather.agent.TravelInfoAgent",
        generate_images,
        search_knowledge_base,
        list_documents_in_knowledge_base,
        "apps.agents.tools.session.session_tools.session_set",
        "apps.agents.tools.session.session_tools.session_get",
