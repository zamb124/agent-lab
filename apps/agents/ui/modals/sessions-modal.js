...
export class SessionsModal extends PlatformModal {
    ...
    async _loadSessions() {
        this.loading = true;
        this.sessions = await this.a2a.getSessions(this.selectedAgentId || null);
        this.loading = false;
    }

    _onAgentFilterChange(e) {
    ...
    async _selectSession(session) {
        ...
        AgentsStore.loadSession(session.session_id, messages, session.agent_id, sessionTaskId);
    ...
    async _deleteSession(sessionId, e) {
        ...
        await this.a2a.deleteSession(this.selectedAgentId, sessionId);
    ...
    renderBody() {
        ...
        return html`
            <div class="filters">
                <span class="filter-label">Агент:</span>
                <select 
                    class="filter-select" 
                    .value=${this.selectedAgentId}
                    @change=${this._onAgentFilterChange}
                >
                            ...
                            >
                                ...
                                <div class="session-info">
                                    <div class="session-header">
                                        <span class="session-agent">${this._getAgentName(session.agent_id)}</span>
