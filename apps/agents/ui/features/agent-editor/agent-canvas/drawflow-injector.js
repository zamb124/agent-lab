...
agent-canvas .context-menu-item {
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 8px 12px;
...
agent-canvas .context-menu-item:hover {
    background: rgba(255,255,255,0.08);
}

agent-canvas .context-menu-item.danger {
    color: #f43f5e;
}

agent-canvas .context-menu-item.danger:hover {
    background: rgba(244, 63, 94, 0.12);
}

agent-canvas .context-menu-item.active {
    color: #10b981;
}

agent-canvas .context-menu-separator {
    height: 1px;
    background: rgba(255,255,255,0.08);
    margin: 4px 0;
}
...
export function injectDrawflowStyles() {
    ...
    console.log('[AgentCanvas] Drawflow styles injected');
}
