...
export class PlatformChat extends PlatformIsland {
    ...
    async _onSendMessage(e) {
        ...
        AgentsStore.addMessage(userMessage);
        ...
        AgentsStore.addMessage(assistantMessage);
        ...
        await this.a2a.streamMessage(
            ...
            AgentsStore.updateMessage(assistantMessage.id, {
    ...
    _handleStreamEvent(event, messageId) {
        ...
        if (event.error) {
            ...
            AgentsStore.updateMessage(messageId, { 
        ...
        if (result.kind === 'artifact-update') {
            ...
            if (artifact?.parts) {
                ...
                if (text) {
                    ...
                    if (artifact.name === 'reasoning') {
                        ...
                        AgentsStore.appendToMessageField(messageId, 'reasoning', text);
                    } else {
                        AgentsStore.appendToMessage(messageId, text);
                    }
                }
            }
            ...
            if (message && message.parts) {
                ...
                if (reasoning?.text) {
                    AgentsStore.updateMessage(messageId, { reasoning: reasoning.text });
                }
            }

            if (message && message.metadata) {
                if (message.metadata.tool_calls) {
                    const messages = AgentsStore.state.chat.messages;
            ...
            if (state === 'completed' && result.final) {
                ...
                AgentsStore.updateMessage(messageId, { streaming: false, taskId });
                ...
                if (message && message.parts) {
                    ...
                    if (text) {
                        ...
                        if (msg && !msg.content.trim()) {
                            AgentsStore.updateMessage(messageId, { content: text });
                        }
                    }
                }
            }
    ...
    _handleStatusUpdate(result, messageId) {
        ...
        if (state === 'completed' && result.final) {
            AgentsStore.updateMessage(messageId, { streaming: false });
            ...
            <div class="island">
                <header class="chat-header">
                    <div class="chat-title-section">
                        ...
                        <div>
                            <h1 class="chat-title">
                                <span class="agent-name" title="${this.agentName || this.agentId}">${this.agentName || this.agentId}</span>
                    ...
                    <div class="chat-actions">
                        ...
                        <button class="action-btn" @click=${this._editAgent} title="Редактировать агента">
                        ...
                        <div class="mobile-actions-container">
                            ...
                            <div class="actions-dropdown ${this._actionsMenuOpen ? 'open' : ''}" @click=${(e) => e.stopPropagation()}>
                                ...
                                <button class="actions-dropdown-item" @click=${() => { this._editAgent(); this._closeActionsMenu(); }}>
