...
@trace_span(
    name="state_modifier.render_state_variables",
    span_type=SpanType.OTHER,
    metadata={"component": "state_modifier", "operation": "render_state_variables"}
)
...
@trace_span(
    name="state_modifier.handle_special_function",
    span_type=SpanType.OTHER,
    metadata={"component": "state_modifier", "operation": "handle_special_function"}
)
