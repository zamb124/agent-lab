...
from apps.agents.src.clients.mcp_client import (
    MCPClientError,
    MCPHttpClient,
    clear_mcp_client_cache,
)
from apps.agents.src.container import AgentContainer, get_container
from apps.agents.src.models.mcp import MCPServerConfig, MCPToolInfo, MCPTransportType
...
async def update_server(
    ...
    if "transport_type" in update_data and update_data["transport_type"]:
        from apps.agents.src.models.mcp import MCPTransportType
...
async def sync_server_tools(
    ...
    from apps.agents.src.models.enums import CodeMode
