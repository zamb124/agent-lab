...
class ResourceResolver:
    """
    Резолвит ресурсы для нод агента.
    
    Порядок приоритета: node > skill > agent
    """
    ...
    async def resolve_for_node(
        self,
        agent_resources: Optional[Dict[str, ResourceReference]] = None,
        ...
        Приоритет: node > skill > agent
        
        Args:
            agent_resources: Ресурсы агента
