...
description: "Современная документация Humanitec: быстрый старт, API, руководства и автособранные сценарии интерфейса."
---

<div class="docs-home">
  <p class="docs-page-kicker">Humanitec Docs</p>
  <p class="docs-lead">Документация для платформы ИИ-агентов, Flows, Sync, NetWorkle и RAG. Здесь есть быстрый старт, публичные API и автособранные E2E-сценарии с реальными скриншотами интерфейса.</p>
  ...
  <div class="docs-home-visual">
    <div class="docs-product-shot">
      <img src="scenarios/flows/flows-shell/screenshots/002.png" alt="Интерфейс Flows в Humanitec">
    </div>
...
<div class="docs-card-grid">
  ...
  <a class="docs-card" href="guides/">
    ...
    <h2>Руководства</h2>
    <p>Обзорные материалы и входные точки для продуктовых команд.</p>
  </a>
</div>
