...
Langfuse предоставляет детальный мониторинг, трассировку и аналитику для ваших агентов.
...
# Langfuse будет доступен на:
# - Web UI: http://localhost:3000
```

**Важно**: После первого запуска сгенерируйте API ключи в Langfuse UI и обновите `LANGFUSE_INIT_PROJECT_PUBLIC_KEY` и `LANGFUSE_INIT_PROJECT_SECRET_KEY` в `.env` файле (ВРЕМЕННО, ПОКА НЕ БУДЕТ ИЗОЛЯЦИИ ПО КОМПАНИЯМ)
