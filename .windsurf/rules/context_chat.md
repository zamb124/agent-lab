...
1. Документируй каждый значительный шаг в разработке в следующих файлах:
   - /artifacts/docs/changelog.md - хронологический журнал всех изменений
   - /artifacts/docs/tasktracker.md - статус выполнения задач с описанием
...
10. Не оставляйте неиспользуемый код и комментарии. Комментарии допустимы только для очень неявного кода
