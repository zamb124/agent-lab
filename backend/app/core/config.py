...
class LLMProviderConfig(BaseModel):
    ...
    max_retries: int = 3
    enabled: bool = True
    models: Dict[str, Dict[str, Any]] = Field(default_factory=dict)  # Специфичные настройки для моделей
...
class S3Config(BaseModel):
    ...
    buckets: Dict[str, S3BucketConfig] = Field(default_factory=dict)  # Конфигурации бакетов
